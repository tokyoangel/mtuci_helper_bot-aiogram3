...
from texts_message.dormitory_txt import dormitory_txt_start,dormitory_txt1,dormitory_txt3,dormitory_txt4,dormitory_txt_info
...
async def where_def(message: types.Message | CallbackQuery):
    ...
    await message.answer(dormitory_txt_start,reply_markup=get_callback_btns(
        btns={
...
async def chouse_camp(callback: types.CallbackQuery):
    ...
    if campus == "dormitory_info":
        ...
        await callback.message.answer(dormitory_txt1,reply_markup=get_inlineMix_btns(
            btns={
        ...
        await callback.message.answer(dormitory_txt3,reply_markup=get_inlineMix_btns(
            btns={
        ...
        await callback.message.answer(dormitory_txt4,reply_markup=get_inlineMix_btns(
            btns={
